...
public static void main(String[] args) {
       ...
       ItemPrice PriceSearch = new ItemPrice(); 
       ItemInstructions InstructionSearch = new ItemInstructions();
        for(HouseholdItem item : householdItmes ) {
        	PriceSearch.getPrice(item);
        	
        	 }
        for(HouseholdItem item : householdItmes ) {
        	
        	InstructionSearch.getInstruction(item);
        	 }
